...
const skills = [
  ...
  {
    category: "DevOps, Quality & Practice",
    items: [
      "Kubernetes",
      "Docker",
      "Helm",
      ...
      <div className="max-w-7xl mx-auto relative">
        ...
        >
          ...
          <p className="text-gray-400 text-lg max-w-2xl leading-relaxed">
            Tools and stacks used to build regulated, high-scale healthcare products—with a strong focus on quality and accessibility.
          </p>
        </motion.div>
