        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <h4>Scheduling, revenue &amp; clinical workflows</h4>
              <p>
                I design modular UIs and services for scheduling and revenue
                cycle products—reusable components, OpenAPI integrations, and
                modernization paths that improve speed and accessibility.
              </p>
              <h5>Skillset &amp; tools</h5>
              <div className="what-content-flex">
                <div className="what-tags">Oracle JET</div>
                <div className="what-tags">React</div>
                <div className="what-tags">TypeScript</div>
                <div className="what-tags">OpenAPI</div>
                <div className="what-tags">WCAG</div>
                <div className="what-tags">Oracle APEX</div>
              </div>
