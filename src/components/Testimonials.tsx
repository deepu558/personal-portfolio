...
const TESTIMONIALS = [
  {
    quote:
      "Manideep consistently turned ambiguous scheduling requirements into shippable UI—strong ownership from design reviews through production.",
    name: "Engineering lead",
    role: "Healthcare product organization",
    initials: "EL",
  },
  {
    quote:
      "His debugging discipline cut repeat defects on our team. You can hand him a gnarly legacy stack and get a clear root cause, not a guess.",
    name: "Senior peer",
  ...
  {
    quote:
      "From Rails APIs to React flows, he bridges backend and frontend without dropping accessibility or operational concerns.",
    name: "Tech lead",
  ...
  {
    quote:
      "The semantic search work landed with measurable impact—faster discovery for users and a metadata model the team could extend.",
    name: "Product partner",
    role: "Scheduling platform",
    initials: "PP",
  },
];
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
       ...
       <div className="container mx-auto px-6 mb-16 text-center relative z-10">
            ...
            <p className="text-gray-400 text-lg max-w-xl mx-auto mb-10 leading-relaxed">
                Paraphrased themes from engineering and product partners—names withheld for confidentiality.
            </p>
