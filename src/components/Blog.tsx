...
const ARTICLES = [
  {
    title: "Semantic search in regulated healthcare UIs",
    excerpt:
      "Designing metadata and vector-friendly semantic objects so clinicians find the right appointment context—without sacrificing governance or latency.",
  ...
  {
    title: "Modernizing revenue cycle with accessibility first",
    excerpt:
      "Lessons from migrating legacy Revenue Cycle screens to React and Oracle APEX while meeting WCAG and real hospital operations.",
  ...
  {
    title: "Rails, React, and the long life of enterprise health apps",
    excerpt:
      "Why Ruby on Rails APIs and React front ends still win for iterative clinical features—and how WebSockets fit when the server owns the truth.",
