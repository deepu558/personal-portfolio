...
const Icons = {
  ...
  Cube: (props: any) => (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="m21 16-6 3.5-6-3.5-6 3.5V8l6-3.5L15 8l6-3.5V16Z"/><path d="m3 8 6 3.5L15 8"/><path d="M9 11.5V21"/><path d="m15 8 6 3.5V21"/></svg>
  ),
};
...
const DOCK_ITEMS = [
  ...
  { id: "3d-portfolio", icon: Icons.Cube, label: "3D view", href: "/3d-portfolio" },
  { id: "resume", icon: Icons.FileText, label: "Resume", href: "/Manideep_Grandhe_Resume.pdf", external: true },
];
